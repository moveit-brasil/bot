...
(function () {
	...
	var basicBot = {
		...
		name: "Move It-Bot",
		loggedInID: null,
		scriptLink: "https://dl.dropbox.com/s/8lzq4vhmzhgbgzi/eventos.js",
		...
		settings: {
			...
			themeLink: "Tema: Apenas gêneros brasileiros, com destaque as marchinhas carnavalesca! (Zoeira somente das 22h às 07h, vídeos NSFW são proibidos :underage:)",
			...
			msgCommand: {
				...
				functionality: function (chat, cmd) {
					...
					if (!basicBot.commands.executable(this.rank, chat)) return void (0);
					   ...
					   var c, mensagens;
					  mensagens = ["/me Tema: Apenas gêneros brasileiros, com destaque as marchinhas carnavalesca! (Zoeira somente das 22h às 07h, vídeos NSFW são proibidos :underage:)",
				"/me Discord da sala - https://discord.me/move-it",
				"http://i.imgur.com/M2y1h4R.jpg",
