		...
		commands: {
			...
			activeCommand: {
				...
				functionality: function (chat, cmd) {
					...
					API.sendChat(subChat(basicBot.chat.activeusersintime, {name: chat.un, amount: chatters, time: durationOnline}));
				    }
				}
			    },
		 ...
		 sairppCommand: {
			...
			msgCommand: {
				...
				"/me Compre o Sub do Plug (assinatura) por boleto em https://moveitbrasil.com.br/loja/",
				"/me Confira nossas regras em - https://moveitbrasil.com.br/regras/",
				"/me Quer ter uma foto no chat? http://i.imgur.com/Q8OTszL.jpg Digite !foto cadastre-se em nosso site e siga as instruções!",				
